...
| Req-ID | Beschreibung | Systemkomponente | Zugehörige Klassen | Methoden / Schnittstellen | **Sprint 1 – NR** | **Sprint 1 – Implementierung** | **Sprint 1 – Testfälle** | **Sprint 2 – NR** | **Sprint 2 – Implementierung** | **Sprint 2 – Testfälle** | **Sprint 3 – NR** | **Sprint 3 – Implementierung** | **Sprint 3 – Testfälle** |
|--------|--------------|------------------|---------------------|----------------------------|-------------------|-------------------------------|---------------------------|-------------------|-------------------------------|---------------------------|-------------------|-------------------------------|---------------------------|
...
| **F5** | Logging von Status & Messdaten | DM – CsvLogger | `CsvLogger`, `FileDriver` | `logStatus()`, `rotateLogIfNeeded()` |  |  |  |  |  |  | 3 | `logStatus()`, `rotateLogIfNeeded()` | 🟢 TC-LOG1, 🟢 TC-LOG2 |
...
| **NF5** | Dateigröße & Log-Rollover | DM – CsvLogger | `CsvLogger`, `FileDriver` | `checkFileSize()`, `rotateLogIfNeeded()` |  |  |  |  |  |  | 3 | `checkFileSize()`, `rotateLogIfNeeded()` | 🟢 TC-LOG3 |
...
**Hinweis Sprint 3:**  
In Sprint 3 wurden alle relevanten Testfälle aus Sprint 1 und Sprint 2 als **Regressionstests** erneut durchgeführt. Zusätzlich wurden neue Testfälle für **CSV-Logging und Log-Rollover (F5, NF5)** eingeführt und erfolgreich abgeschlossen.
