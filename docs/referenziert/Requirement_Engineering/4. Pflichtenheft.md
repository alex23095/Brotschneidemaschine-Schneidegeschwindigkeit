...
Das System regelt die Drehzahl des Schneidemotors in definierten Stufen, überwacht die Betriebsgrößen und protokolliert den Maschinenzustand.  
Nach einer festgelegten kumulierten Laufzeit wird ein Wartungshinweis ausgegeben, um Verschleiß frühzeitig zu erkennen.  

---

## 2. Ausgangsbasis
**Referenz:** Lastenheft „Brotschneidemaschine – Schneidegeschwindigkeitsregelung“  
**Grundlagen:**  
...
|-----|--------------|---------------|----------------------------|
| TF-01 | Schneidemotor- und Geschwindigkeitssteuerung | Umsetzung der Sollgeschwindigkeit in 10 %-Schritten sowie sichere Abschaltung bei Not-Halt | F1, F2, NF2 |
| TF-02 | Monitoring der Betriebsgrößen | Erfassung und Mittelwertbildung der Stromaufnahme zur Zustandsüberwachung des Schneidemotors | F3 |
...
| TF-05 | Systemlogik und Betriebszustände | Verwaltung der Zustände RUN, STOP, FAULT und Koordination aller Teilfunktionen | F1–F5, NF3, NF5 |
